const InternalLoadingThinkCard: React.FC = () => {
  return (
    <div className="w-full px-5 border border-gray-200 bg-white shadow-sm hover:shadow-md duration-300 cursor-pointer">
      ...
      <div className="flex items-baseline font-ubuntu py-3">
        <div className="h-5 w-10 rounded bg-gray-300 animate-pulse" />
        {" · "}
        <div className="h-5 w-16 rounded bg-gray-300 animate-pulse" />
      </div>
    </div>
  );
};

export default InternalLoadingThinkCard;
